...
An extensible Java quiz platform supporting user session tracking, persistent performance storage, and difficulty-balanced question allocation.

Java Assessment Engine
Overview
...
Open a terminal or command prompt and navigate to the directory containing the source files (the src folder).
Compile all the Java files using the following command: javac *.java
